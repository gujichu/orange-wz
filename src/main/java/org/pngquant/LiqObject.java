...
abstract class LiqObject {
    ...
    private static void loadLib(File directory, String libName) throws IOException {
        String classpathPath = "libimagequant/" + libName;
        FileUtils.copyInputStreamToFile(getResourceAsStream(classpathPath), new File(directory, libName));
